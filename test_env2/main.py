...
def main():
    ...
    parser.add_argument('--model-for-training', type=int, default=1)
    ...
    if args.make_dataset != 0:
        for i in range(10):
            train_dataset1, train_dataset2, test_dataset1, test_dataset2 = make_dataset3()
    ...
    for i in range(10):
        train_dataset1_name = './dataset/train_dataset1-' + str(i) + '.pkl'
        train_dataset2_name = './dataset/train_dataset2-' + str(i) + '.pkl'
        with open(train_dataset1_name, 'rb') as f:
            train_dataset1 = pickle.load(f)
        with open(train_dataset2_name, 'rb') as f:
            train_dataset2 = pickle.load(f)

        test_dataset1_name = './dataset/test_dataset1-' + str(i) + '.pkl'
        test_dataset2_name = './dataset/test_dataset2-' + str(i) + '.pkl'
        with open(test_dataset1_name, 'rb') as f:
            test_dataset1 = pickle.load(f)
        with open(test_dataset2_name, 'rb') as f:
             test_dataset2 = pickle.load(f)

        batch_size = 32

        if args.model_for_training == 1:
        ...
        elif args.model_for_training == 2:
