...
# 'intensity', 'exposure_time', 'cured_height', test_dataset2 대용
test_data_list = []
...
# unique_combinations = df_experiment[['cured_height']].drop_duplicates()
# print(unique_combinations)
# print('\n')
# df_scaled = pd.read_csv('./data_minmax_scale.csv')
# unique_combinations = df_scaled[['cured_height']].drop_duplicates()
# print(unique_combinations)
